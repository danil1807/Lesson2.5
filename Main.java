...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        new Thread(() -> test1.createArr1()).start();
        new Thread(() -> test1.createArr2()).start();
//как лучше?
        //через поток скорость выполнения выше. но можно ли так выполнять программу?
        //Если можно, то зачем тогда использовать вызов метода не через поток?
